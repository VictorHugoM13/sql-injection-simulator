...
Permite adicionar outra condição à consulta.
...
adiciona uma condição verdadeira à consulta.

#

No MySQL, # inicia um comentário que continua até o final da mesma linha.

Assim, parte restante da consulta deixa de ser considerada na execução.
...
Os valores enviados pelo formulário são inseridos diretamente na consulta SQL.

Isso permite que o usuário forneça caracteres que interfiram na estrutura do comando SQL.
...
Para aprofundar os estudos sobre SQL Injection, consulte a PortSwigger Web Security Academy.
